  <template>
    ...
    <el-upload action="api/UploadImg" :on-success="success" :show-file-list="isShow" list-type="picture-card" name="smfile" :on-preview="handlePictureCardPreview" :on-remove="handleRemove">
